...
import HeaderText from "./Componentes/Header/Index";

import { FundoGradiente } from "./Componentes/Styles/globalStyled";
import Carousel from "./Componentes/Carousel/Index";
import Experiencias from "./Componentes/Experiencias/Index";
